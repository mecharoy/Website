        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#research" className="text-sm text-muted-foreground hover:text-warm transition-colors">
                  Research
                </a>
              </li>
              <li>
                <a href="#team" className="text-sm text-muted-foreground hover:text-warm transition-colors">
                  Team
                </a>
              </li>
              <li>
                <a href="#about" className="text-sm text-muted-foreground hover:text-warm transition-colors">
                  About
                </a>
              </li>
              <li>
                <a href="#contact" className="text-sm text-muted-foreground hover:text-warm transition-colors">
                  Contact
                </a>
              </li>
            </ul>
